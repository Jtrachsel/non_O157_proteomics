...
NOMAD, [Normalization of mass spectrometry data](https://pubmed.ncbi.nlm.nih.gov/29174395/), was used to normalize peptide reporter ion intensities and aggregate peptide reporter ion intensities to protein level intensities. This type of normalization is similar to what can be performed in Scaffold.
...
iTRAQ reporters 1, 2, and 3 were assumed to be the in-vivo condition.  
iTRAQ reporters 4, 5, and 6 were assumed to be the in-vitro condition.  

If this is incorrect, the group labels in this report are reversed.  
...
```{r, code = readLines("./scripts/03_iTRAQ.R"), message=FALSE, warning=FALSE, eval=FALSE}
...
-   table:
    ...
    -   Total prots\
    -   Num enriched in in-vivo\
    -   Num enriched in in-vitro\
    -   Num not different

-   descriptive table of diffabund
